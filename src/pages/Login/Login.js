    ...
    try {
      ...
      if (response?.data?.result?.match) {
        navigate("/auth/register", {
          state: { auth_info: response?.data?.result?.auth_info },
        });
      }
    ...
    <>
      ...
      <div className="d-flex flex-column flex-root bg-dark  ">
        <div className="d-flex flex-column flex-column-fluid flex-lg-row z-3">
          ...
          <div className="card-container d-flex flex-center col-lg-6 justify-content-center align-items-center w-lg-50 p-5">

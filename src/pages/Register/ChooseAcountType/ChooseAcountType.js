...
function ChooseAcountType() {
  const navigate = useNavigate();
  const location = useLocation();
  const dispatch = useDispatch();
  const [selectedType, setSelectedType] = useState();
  const authToken = location?.state?.auth_info?.token;
  const businessTypeInfo = location?.state?.auth_info?.business_types_info;
                ...
                <div className="fv-row">
                  <div className="row justify-content-center">
                    <div className="col-12 col-sm-6 col-md-4">
                      ...
                      <label
                        className="btn btn-active-light-warning p-4  align-items-center mb-1"
                      ...
                      >
                        <div className="d-flex">
                          ...
                          <span className="d-block fw-semibold text-start">
                            ...
                            <span className="ms-4">
                              {businessTypeInfo?.business?.price}
                            </span>
                          </span>
                        </div>
                      </label>
                      <div>
                        <p className="account-type-description">
                          {businessTypeInfo?.business?.description}
                        </p>
                      </div>
                    </div>
                    <div className="col-12 col-sm-6 col-md-4">
                      ...
                      />
                      <label
                        className="btn btn-active-light-warning p-4 d-flex align-items-center mb-1"
                      ...
                      >
                        ...
                        <span className="d-block fw-semibold text-start">
                          ...
                          <span className="ms-4">
                            {businessTypeInfo?.private?.price}
                          </span>
                        </span>
                      </label>
                      <div>
                        <p className="account-type-description">
                          {businessTypeInfo?.private?.description}
                        </p>
                      </div>
                    </div>
                  </div>
...
export default ChooseAcountType;
